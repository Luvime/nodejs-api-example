...
//MIDLEWARE entre la peticion y la API
...
app.delete("/dishes/:id", (req, res) => {
    ...
    writeData(data)
    res.json({ message: "El plato fue eliminado satisfactoriamente" })
})
...
app.put("/books/:id", (req, res) => {
    ...
    writeData(data)
    res.json({ message: "Book updated succuessfully"})
})
...
app.delete("/books/:id", (req, res) => {
    ...
    writeData(data)
    res.json({ message: "El libro fue eliminado satisfactoriamente" })
})
